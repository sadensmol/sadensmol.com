...
<img src="/images/profile.jpg" alt="Denis Sazonov" style="float:left; width:150px; margin-right:20px; margin-bottom:10px;">
...
- [Swipe Games](https://swipegames.io/)  
  _iGaming development and consultations_  
  **Lead Back end Developer, Full-time [July, 2025 - now]**  
  I'm working on the core platform, architecture, CI/CD and games logic including high load single and multiplayer games, including
  new innovative video based reels (tik-tok like).
  3rd party integrations, payment gateway, public API, documentation.  
  Technologies: iGaming, Go, Postgres, Redis, GRPC, GitHub, AWS.

- [Playhub](https://www.playhub.studio/)  
  _iGaming development and consultations_  
  **Lead Back end Developer, Full-time [January, 2023 - July, 2025]**  
...
- [finmid](https://finmid.com/)  
  _Fintech company in B2B credit card, BNPL area._  
...
- [Talent Funnel](https://www.talent-funnel.com/)  
  _Applicants tracking system for HR agencies._  
...
- [Klever Thoughts Inc.](https://www.investigationve.com/)  
  _Software development and consultation for surveillance industry._  
...
- [Tangelo Games, Israel](https://tangelogames.com/)  
  _Facebook based online casino platform with different games._  
...
- [Cristian Filipina](https://www.christianfilipina.com/)  
  _Dating portal with web and mobile applications including voice and video chat._  
...
- [TopDog](https://www.topdog.ru.net/)  
  _International flights/accomodation booking portal._  
